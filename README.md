...
Validate your rules against deterministic payloads. Typical detection patterns generated:

```apache
# Detect OS Command Injection separators
SecRule ARGS "@rx [;&|`\$]" "id:1003,phase:2,block,msg:'Command Injection Detected'"

# Detect Path Traversal (LFI)
SecRule ARGS "@rx \.\./\.\./" "id:1004,phase:2,t:urlDecodeUni,block,msg:'LFI Attempt'"
```
